...
pub struct CodexToolCallParam {
    ...
    /// `untrusted`, `on-failure`, `on-request`, `trust-sandbox`,
    /// `trust-sandbox-timeout`, `never`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl From<CodexToolCallApprovalPolicy> for AskForApproval {
    fn from(value: CodexToolCallApprovalPolicy) -> Self {
        match value {
            ...
            CodexToolCallApprovalPolicy::TrustSandbox => AskForApproval::TrustSandbox,
            CodexToolCallApprovalPolicy::TrustSandboxTimeout => AskForApproval::TrustSandboxTimeout,
    ...
    fn verify_codex_tool_json_schema() {
        ...
        let expected_tool_json = serde_json::json!({
          ...
          "inputSchema": {
            ...
            "properties": {
              "approval-policy": {
                "description": "Approval policy for shell commands generated by the model: `untrusted`, `on-failure`, `on-request`, `trust-sandbox`, `trust-sandbox-timeout`, `never`.",
                "enum": [
                  "untrusted",
                  "on-failure",
                  "on-request",
