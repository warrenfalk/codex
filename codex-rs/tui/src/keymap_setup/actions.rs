...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "toggle_clean_scrollback", "Toggle clean scrollback mode."),
    ...
    action("composer", "Composer", "rewrite_prompt", "Rewrite the draft for clarity and concision."),
    ...
    action("editor", "Editor", "undo", "Undo the most recent draft edit."),
    action("editor", "Editor", "redo", "Redo the most recently undone draft edit."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "toggle_clean_scrollback") => Some(&mut keymap.global.toggle_clean_scrollback),
        ...
        ("composer", "rewrite_prompt") => Some(&mut keymap.composer.rewrite_prompt),
        ...
        ("editor", "undo") => Some(&mut keymap.editor.undo),
        ("editor", "redo") => Some(&mut keymap.editor.redo),
