...
impl App {
    ...
    async fn save_completed_side_summary(
        ...
        self.enqueue_thread_notification(
            pending.parent_thread_id,
            ServerNotification::ItemCompleted(Self::side_summary_item_completed_notification(
                pending.parent_thread_id,
                pending.side_thread_id,
                summary,
            )),
        ...
        self.enqueue_thread_notification(
            pending.parent_thread_id,
            ServerNotification::TurnCompleted(Self::side_summary_turn_completed_notification(
                pending.parent_thread_id,
                pending.side_thread_id,
                summary,
            )),
